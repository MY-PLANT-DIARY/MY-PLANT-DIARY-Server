package com.myplantdiary.global.http;

public class ResponseMessage {
    public static final String LOGIN_SUCCESS = "로그인 성공";
    public static final String LOGIN_FAIL = "로그인 실패";
    public static final String CREATED_USER = "회원 가입 성공";
    public static final String CREATED_POST = "게시물 등록 성공";
    public static final String READ_POSTS = "게시물 정보 조회 성공";
    ...
    public static final String MINUS_DAY = "DAY 1일 감소 성공";
